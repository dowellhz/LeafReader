...
private let tests: [(String, () throws -> Void)] = [
    ...
    ("Kokoro speech speed multiplier", AISettingsLogicTests.testKokoroSpeechSpeedMultiplier),
    ...
    ("Vocabulary audio cache key", AISettingsLogicTests.testVocabularyAudioCacheKeySeparatesSpeechSettings),
    ...
    ("Speech runtime local runtime descriptors", AISettingsLogicTests.testSpeechRuntimeLocalRuntimeDescriptors),
    ("Speech runtime local runtime download plans", AISettingsLogicTests.testSpeechRuntimeLocalRuntimeDownloadPlans),
    ("Speech runtime local runtime registry", AISettingsLogicTests.testSpeechRuntimeLocalRuntimeRegistry),
    ("Speech model manifest checksum validation", AISettingsLogicTests.testSpeechModelManifestParsingAndChecksumValidation),
    ("Local runtime download manifest asset decoding", AISettingsLogicTests.testLocalRuntimeDownloadManifestAssetDecoding),
    ...
    ("Speech runtime download configuration", AISettingsLogicTests.testSpeechRuntimeDownloadConfigurationAndProgressTotals),
    ("Speech model manifest decode fallback", AISettingsLogicTests.testSpeechModelManifestDecodeFallsBackToBundledManifest),
    ("Speech runtime install disk space policy", AISettingsLogicTests.testSpeechRuntimeInstallDiskSpacePolicy),
    ...
    ("Local runtime status presenter", AISettingsLogicTests.testLocalRuntimeStatusPresenter),
    ...
    ("Piper archive voice validation", AISettingsLogicTests.testPiperArchiveValidationRequiresPackagedVoice),
    ...
    ("Local runtime install manifest compatibility", AISettingsLogicTests.testLocalRuntimeInstallManifestCompatibility),
