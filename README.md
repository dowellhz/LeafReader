...
[Leaf Reader 1.4.13 pkg installer](https://github.com/dowellhz/LeafReader/releases/download/v1.4.13/LeafReader-1.4.13.pkg)
...
[Leaf Reader-1.4.13.pkg](https://github.com/dowellhz/LeafReader/releases/download/v1.4.13/LeafReader-1.4.13.pkg)
...
```sh
SPARKLE_PRIVATE_KEY_FILE=/path/to/sparkle-ed25519-private-key ./scripts/release_pkg.sh 1.4.13
```
