...
final class AISettingsPanelController {
    ...
    weak var supertonicSpeechStatusLabel: NSTextField?
    ...
    weak var supertonicSpeechProgressIndicator: NSProgressIndicator?
    ...
    weak var supertonicSpeechDownloadButton: NSButton?
    ...
    weak var supertonicSpeechPauseButton: NSButton?
    ...
    weak var supertonicSpeechCancelButton: NSButton?
    ...
    weak var supertonicSpeechDeleteButton: NSButton?
